...
void RCC_voidEnableClock(u8 Copy_u8BussID,u8 Copy_u8PrelID)
{
   if( Copy_u8PrelID <=31)
   {
	  ...
	  {
		  case RCC_AHP  :
		  SET_BIT(RCC_AHBENR     ,Copy_u8BussID);
		  break;
		  case RCC_APB1 :
		   SET_BIT(RCC_APB1ENR   ,Copy_u8BussID);
		   break;
		  case RCC_APB2 :
		  SET_BIT(RCC_APB2ENR   ,Copy_u8BussID);
		   break;
...
void RCC_voidDisenableClock(u8 Copy_u8BussID,u8 Copy_u8PrelID)
{
   ...
   if( Copy_u8PrelID <=31)
   {
	  ...
	  {
		  case RCC_AHP  :
		  CLR_BIT(RCC_AHBENR     ,Copy_u8BussID);
		  break;
		  case RCC_APB1 :
		   CLR_BIT(RCC_APB1ENR   ,Copy_u8BussID);
		   break;
		  case RCC_APB2 :
		  CLR_BIT(RCC_APB2ENR   ,Copy_u8BussID);
